...
public class XdocReportDialog extends AbstractDataInput {
	...
	private JPanel createDocsPanel() {
		Vector docxs = ConnectionManager.getAccessTo(PluginManager.getMyFile("XDoc", "xd_config")).search(null, null);
		...
		wb.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				if (directoryChooser == null) {
					...
					directoryChooser = new WebDirectoryChooser(PlanC.frame);
				}
