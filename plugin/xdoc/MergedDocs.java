...
public class MergedDocs extends UIListPanel implements DockingComponent {
	...
	public MergedDocs() {
		super(null);
		String qfn = PluginManager.getMyFile("XDoc", "xd_merged_doc");
		...
		putClientProperty(TConstants.SHOW_COLUMNS, "xd_mddate;xd_mddoc_name;xd_mdcertificate;xd_mdremittent");
		putClientProperty(TConstants.ICON_PARAMETERS, "0;/plugin/xdoc/server_document");
	}
