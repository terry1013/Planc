...
public class XDocAction extends TAbstractAction {
	...
	public void actionPerformed(ActionEvent arg0) {
		...
		SplitWindow sw = new SplitWindow(false, 0.6f,
				DockingContainer.createDynamicView("plugin.xdoc.DocumentRecipient"),
				DockingContainer.createDynamicView("plugin.xdoc.MergedDocs"));
